...
def waterfallPlot(b, i=(0,1), ee=1):
...
## Scrambling-to-write-my-physics-thesis-type plotting functions:
...
if __name__=='__main__':
    ...
    explore3('store_state2', from0_lbs=np.arange(6,8)/10, from0_ubs=np.arange(7,9)/10, sims=10)
"""
...
if __name__=='__main__':
    NVals = (1,3)
    from0_lbs = np.append(np.arange(3,13)/10, [2])
    from0_ubs = np.append(np.arange(4,14)/10, [2])
